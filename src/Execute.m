...
while K~=12 % arrêter
   ...
   if K==1 % NEW
      ...
      Hermite(matrice, matricep, resolution, 1, 'r');
   ...
   elseif K==2 
      ...
      Hermite(matrice, matricep, resolution, 0, 'r');
   ...
   elseif K==3
      ...
      %matriced2 = calcule_k(matrice, c, 0, 0.5);
      Hermite(matrice, matricep, resolution, 0, 'r');
      %Hermite(matrice, matriced, resolution, 0, 'm');
      %Hermite(matrice, matriced2, resolution, 0, 'b');
      figure
      hold on
      courbure(matrice, matricep, 'r');
      %courbure(matrice, matriced2, 'b');
      %courbure(matrice, matriced, 'm');
   elseif K==4 
   ...
   elseif K==5
      ...
      Hermite(matrice, matricep, res, 0, 'r');
   ...
   elseif K==7
      ...
      Hermite(matrice, matricep, res, 0, 'b');
      %Lagrange(matrice, res);
      %courbe_C2(matrice, 5*res);
